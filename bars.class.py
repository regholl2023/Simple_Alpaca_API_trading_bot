...
class StockAnalyzer:
    ...
    def analyze_stock(self):
        ...
        # Find indices where first_derivative is below or above detect_factor
        ...
        self.price_now = self.data_close[-1]
    ...
    def plot_results(self):
        if self.plot_switch == 1:
            ...
            # Use 'self.' prefix to access instance variables
            ax.plot(
                self.data_close,
                linewidth=1,
                alpha=0.8,
...
def main():
    ...
    try:
        ...
        print("Symbol: ", analyzer.symbol, " caused an error")
